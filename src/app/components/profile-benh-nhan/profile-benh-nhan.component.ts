...
@Component({
  selector: 'app-profile-benh-nhan',
  templateUrl: './profile-benh-nhan.component.html',
  styleUrls: ['./profile-benh-nhan.component.css','../../Content/user/css/maicons.css',
...
export class ProfileBenhNhanComponent implements OnInit {
  ...
  loadBS(){
    ...
    this.id = this.userData.UserId;
      ...
      this.service.getLichKhamChoDuyetMaBN(this.userData.UserId).subscribe(data=>{
        this.choduyet=data;
