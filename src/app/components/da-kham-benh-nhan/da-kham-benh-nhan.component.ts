...
@Component({
  selector: 'app-da-kham-benh-nhan',
  templateUrl: './da-kham-benh-nhan.component.html',
  styleUrls: ['./da-kham-benh-nhan.component.css','../../Content/user/css/maicons.css',
...
export class DaKhamBenhNhanComponent implements OnInit {
  ...
  loadBS(){
    ...
    this.id = this.userData.UserId;
      ...
      this.service.getLichKhamCompleteMaBN(this.userData.UserId).subscribe(data=>{
        this.choduyet=data;
